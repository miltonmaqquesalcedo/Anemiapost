<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarDetalleHistoria.aspx.cs" Inherits="ProyectoAnemia.HistDetH.ActualizarDetalleHistoria" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Actualización Detalle Historia</a>
          </div>
                    ...
                    <div class="card">
                      ...
                      <!-- Fecha y Hora -->
                        <div align="center">
                            ...
                            <asp:DropDownList class="form-control" ID="Doctores" runat="server" Width="300px"></asp:DropDownList>
                            <asp:Button class="btn btn-primary btn-sm" ID="btnAceptar" runat="server" Text="Aceptar" 
                                BackColor="#A31621" Height="30px" Width="100px" Onclick="btnAceptar_Click" />
                        </div>
                        <!-- Fecha y Hora -->
                      <div class="card-body">                          
                            <h4 class="card-title">Mis Sintomas</h4>
                        <div class="alert" align="center">
                          <asp:MultiView ID="mvSintomas" runat="server">
                            <asp:View ID="vSintomas" runat="server">
