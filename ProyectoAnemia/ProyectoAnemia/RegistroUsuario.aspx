<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroUsuario.aspx.cs" Inherits="ProyectoAnemia.RegistroUsuario" %>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<asp:TextBox runat="server" ID="txtContrasena" placeholder="Contraseña" Width="300px" TextMode="Password"></asp:TextBox>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<span class="btn-show-pass">
							<i class="zmdi zmdi-eye"></i>
						</span>
						<asp:TextBox runat="server" ID="txtRepetido" placeholder="Repetir Contraseña" Width="182px" TextMode="Password"></asp:TextBox>
					</div>

					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<asp:button class="login100-form-btn" Text="REGISTRARME" runat="server" ID="btnAceptar" BackColor="#A31621" OnClick="btnAceptar_Click" >								 
							</asp:button>
						</div>
					</div>
