<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroDoctor.aspx.cs" Inherits="ProyectoAnemia.RegistroDoctor" %>
					...
					<div class="wrap-input100 " >
						...
						<asp:TextBox ID="txtFechaNacimiento" runat="server" Placeholder="Fecha de Nacimiento" TextMode="Date" ForeColor="Silver"></asp:TextBox>
								...
								<div class="form-row align-items-center ">
									...
									<div class="form-group col-md-4">
										<label for="inputZip">Especialidad</label>
										<div class="wrap-input100 " >
										<asp:TextBox ID="txtEspecialidad" runat="server" Placeholder="Ejm: Nutricionista" ></asp:TextBox>
										</div>
									</div>
									<div class="form-group col-md-3">
										<label for="inputEmail4">CMP</label>
										<div class="wrap-input100 " >
										<asp:TextBox ID="txtCMP" runat="server" Placeholder="Ejm:58GH74 "></asp:TextBox>
										</div>
									</div>									
								</div>	
							<div class="form-row align-items-center">
